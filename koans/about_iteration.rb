...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # A: It works same as 'reduce' methods at functional progrmaming languages: combine
    # all elements into one specific accumulator and convert it to that datatype
  end
  ...
  #   # code to read 'file'
  #
  # A: 'file' variable is scoped and probably that code will execute just if file is correctly
  # opened. (not sure about that)
  #
